...
Now that more and more code is being written by agents, there is often no editor tooling involved so that approach . You could use a prompt (e.g. in `CLAUDE.md`) to make your agent to be aware of your linting tools, but this is not ideal:

...
Although git hooks have been around for a long time, I find that they are not so comonly used, and people would rely their editor for linting, and then configure format-on-save, for example with [Ruby LSP](https://github.com/shopify/ruby-lsp).

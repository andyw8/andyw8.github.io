...
[Zed](https://zed.dev) is a modern, high-performance code editor that's gaining popularity. After several years of using VS Code, I've been trying it out for writing Ruby and I've been impressed. Zed's close [collaboration with Anthropic](https://zed.dev/blog/zed-ai) makes for a strong contender to VS Code derived editors such as [Cursor](https://www.cursor.com).
